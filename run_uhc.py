...
from models.uhc_ka import UHCBert
...
def main():
    ...
    if data_args.task_name is not None and data_args.task_name in glue_tasks:
        ...
        'tnews', 'cnews', 'abstract', 'gs', 'sogou']:  # other supported tasks
    ...
    if data_args.task_name is not None:
        ...
        if "sentence1" in non_label_column_names and "sentence2" in non_label_column_names:
            ...
            if data_args.task_name in ['cnews', 'tnews']:
    ...
    if data_args.task_name in ['tnews', 'ag_news', 'dbpedia_14', 'abstract', 'gs',
                               'yahoo_answers_topics']:  # dataset only has val or test dataset
